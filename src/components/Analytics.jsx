                ...
                <Box sx={{ display: 'flex' }}>
                    ...
                    <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                            <Grid item xs={5}>
                                <Stack direction="row" spacing={2}>
                                    ...
                                    <Card sx={{ width: 100 + '%',height:15 + 'vh', backgroundColor: '#6bb8f2' }}>
                                        <CardContent>
                                        <Typography gutterBottom variant="h5" component="div">
                                                <Stack spacing={2}>
                                                <span className='visit' >   Visitors</span>
                                                <h5> $ <CountUp start={1} end={4300} delay={0.2} /> </h5>
                                                </Stack>
                                            </Typography>
                                            <Typography variant="body2" color="text.white">
                                                Total Earnings
                                ...
                                <Stack direction="row" marginTop={2}  spacing={2}>
                                    <Card sx={{ width: 100 + '%',height:15 + 'vh', backgroundColor: '#1d4f75' }} >
                                        <CardContent>
                                        <Typography gutterBottom variant="h5" component="div">
                                                <Stack spacing={2}>
                                                <span className='visit' >   Visitors</span>
                                    ...
                                    <Card sx={{ width: 100 + '%',height:15 + 'vh', backgroundColor: '#6bb8f2' }}>
                                        ...
                                        <Typography gutterBottom variant="h5" component="div">
                                                <Stack spacing={2}>
                                                <span className='visit' >   Visitors</span>
                                                <h5> $ <CountUp start={1} end={1500} delay={0.2} /> </h5>
                                                </Stack>
                                            </Typography>
                                            <Typography variant="body2" color="text.white">
                                                Total Earnings
                            ...
                            <Grid item xs={7}>
                            <Card sx={{ width: 100 + '%',height:32 + 'vh', backgroundColor: '#fff' }} >
                                        <CardContent>
                                        <Barchart />
                                        </CardContent>
                                    </Card>
                        ...
                        <Grid container rowSpacing={1} marginTop={2} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                            <Grid item xs={8}>
                            <Card sx={{ width: 100 + '%',height:50 + 'vh', backgroundColor: '#fff' }} >
                                        <CardContent>
                                       < GeoChart />
                                        </CardContent>
                                    </Card>
